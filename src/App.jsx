...
const programs = {
  Primaire: {
    Mathématiques: [
      chapter("Nombres et calculs", "Lire les nombres, poser les opérations et résoudre des problèmes simples.", ["Lire les nombres", "Additionner", "Soustraire", "Multiplier", "Résoudre un problème"], [["Calcule : 245 + 138", "383"], ["Calcule : 500 - 125", "375"], ["Calcule : 8 × 7", "56"], ["Calcule : 96 ÷ 12", "8"]]),
      chapter("Fractions et décimaux", "Comprendre les fractions, les parts d’un tout et les nombres décimaux.", ["Lire une fraction", "Comparer", "Décimaux", "Utiliser dans un problème"], [["Quelle fraction représente une moitié ?", "1/2"], ["Dans 3/4, combien de parts sont prises ?", "3"], ["Quelle fraction obtient-on avec 3 parts sur 4 ?", "3/4"], ["0,5 représente quelle fraction simple ?", "1/2"]]),
      chapter("Géométrie et mesures", "Reconnaître les figures, mesurer et calculer des périmètres simples.", ["Figures", "Angles", "Symétrie", "Longueurs"], [["Combien de côtés possède un rectangle ?", "4"], ["Combien d’angles a un triangle ?", "3"], ["Combien de centimètres dans 1 mètre ?", "100"], ["Un carré a-t-il 4 côtés égaux ?", "oui"]]),
    ],
    Français: [
      chapter("Grammaire", "Identifier le sujet, le verbe, le nom, l’adjectif et construire une phrase correcte.", ["Sujet", "Verbe", "Nom", "Adjectif"], [["Dans ‘Le chien court’, quel est le verbe ?", "court"], ["Dans ‘La fille chante’, quel est le sujet ?", "la fille"], ["Dans ‘un grand arbre’, quel est l’adjectif ?", "grand"], ["Dans ‘Les enfants jouent’, quel est le verbe ?", "jouent"]]),
      chapter("Lecture compréhension", "Lire un texte, repérer les informations importantes et répondre avec précision.", ["Lire", "Comprendre", "Repérer", "Justifier"], [["Pourquoi faut-il relire un texte ?", "pour mieux comprendre"], ["Comment répond-on à une question de lecture ?", "avec une phrase"], ["Que cherche-t-on dans un texte ?", "les informations importantes"], ["À quoi sert le titre d’un texte ?", "à présenter le sujet"]]),
    ],
    Anglais: [
      chapter("Se présenter", "Dire son nom, son âge, saluer et parler de ses goûts en anglais.", ["Hello", "My name is", "I am", "I like"], [["Traduis : Bonjour", "hello"], ["Traduis : Je m’appelle Lina", "my name is lina"], ["Que signifie I like ?", "j’aime"], ["Comment dit-on : j’ai dix ans ?", "i am ten years old"]]),
      chapter("Vocabulaire de base", "Apprendre les couleurs, les nombres, les jours et les objets de la classe.", ["Couleurs", "Nombres", "Jours", "Objets"], [["Comment dit-on rouge en anglais ?", "red"], ["Comment dit-on bleu en anglais ?", "blue"], ["Comment dit-on lundi en anglais ?", "monday"], ["Comment dit-on livre en anglais ?", "book"]]),
    ],
    Sciences: [
      chapter("Les états de l’eau", "Comprendre que l’eau peut être solide, liquide ou gazeuse.", ["Solide", "Liquide", "Gaz", "Fusion"], [["Quel est l’état d’un glaçon ?", "solide"], ["Que devient la glace quand elle fond ?", "liquide"], ["La vapeur est-elle un gaz ?", "oui"], ["L’eau du robinet est-elle liquide ?", "oui"]]),
      chapter("Le vivant", "Reconnaître les êtres vivants, leurs besoins et leur croissance.", ["Animaux", "Plantes", "Besoins", "Croissance"], [["Une plante a-t-elle besoin d’eau ?", "oui"], ["Un animal est-il un être vivant ?", "oui"], ["Que permet la lumière aux plantes ?", "grandir"], ["Un caillou est-il vivant ?", "non"]]),
    ],
    "Histoire-Géo": [
      chapter("Lire une carte", "Utiliser une carte, une légende et des symboles pour se repérer.", ["Carte", "Légende", "Symboles", "Repères"], [["À quoi sert la légende d’une carte ?", "à expliquer les symboles"], ["Une carte sert-elle à se repérer ?", "oui"], ["Que représente souvent le bleu sur une carte ?", "l’eau"], ["Que faut-il lire en premier sur une carte ?", "le titre"]]),
      chapter("Se repérer dans le temps", "Comprendre avant, après, les dates et la frise chronologique.", ["Avant", "Après", "Date", "Frise"], [["Sur une frise, que montre une date ?", "un moment"], ["Le passé vient-il avant le présent ?", "oui"], ["Une frise sert-elle à organiser le temps ?", "oui"], ["Aujourd’hui appartient-il au présent ?", "oui"]]),
    ],
    "Culture générale": [
      chapter("Arts et musique", "Découvrir les instruments, les sons et les familles d’instruments.", ["Cordes", "Vent", "Percussions", "Écoute"], [["La guitare est-elle un instrument à cordes ?", "oui"], ["La flûte est-elle un instrument à vent ?", "oui"], ["Le tambour est-il une percussion ?", "oui"], ["Le piano est-il un instrument ?", "oui"]]),
      chapter("Découverte du monde", "Découvrir les pays, monuments, inventions et métiers.", ["Pays", "Monuments", "Inventions", "Métiers"], [["La Tour Eiffel est-elle en France ?", "oui"], ["Un médecin soigne-t-il les personnes ?", "oui"], ["Une invention sert-elle à résoudre un problème ?", "oui"], ["Un monument est-il un lieu important ?", "oui"]]),
    ],
  },
  Collège: {
    Mathématiques: [
      chapter("Calcul numérique", "Priorités opératoires, fractions, nombres relatifs, puissances et calcul littéral.", ["Priorités", "Relatifs", "Puissances", "Expressions"], [["Calcule : 3 + 2 × 5", "13"], ["Calcule : -3 + 8", "5"], ["Calcule : 2²", "4"], ["Calcule : 18 ÷ 3 + 2", "8"]]),
      chapter("Équations", "Résoudre une équation, isoler l’inconnue et vérifier une solution.", ["Inconnue", "Opérations inverses", "Vérifier", "Problèmes"], [["Résous : x + 8 = 15", "x = 7"], ["Résous : x - 4 = 10", "x = 14"], ["Résous : 2x = 10", "x = 5"], ["Résous : x/2 = 6", "x = 12"]]),
      chapter("Proportionnalité", "Tableaux, pourcentages, échelles et problèmes de vitesse.", ["Tableaux", "Pourcentages", "Échelles", "Vitesse"], [["50% de 80 vaut combien ?", "40"], ["10% de 200 vaut combien ?", "20"], ["Si 2 cahiers coûtent 6€, combien coûtent 4 cahiers ?", "12"], ["25% de 100 vaut combien ?", "25"]]),
    ],
    Français: [
      chapter("Analyse de texte", "Identifier le narrateur, les personnages, le cadre et la structure du récit.", ["Narrateur", "Personnages", "Cadre", "Citations"], [["Qui raconte une histoire ?", "le narrateur"], ["Quel élément lance souvent l’histoire ?", "l’élément perturbateur"], ["Pourquoi cite-t-on le texte ?", "pour justifier"], ["Le lieu et l’époque forment quoi ?", "le cadre"]]),
      chapter("Expression écrite", "Organiser ses idées, écrire un paragraphe et améliorer son style.", ["Plan", "Paragraphe", "Connecteurs", "Relecture"], [["À quoi sert un connecteur logique ?", "à relier les idées"], ["Un paragraphe développe-t-il une idée ?", "oui"], ["Pourquoi relire son texte ?", "pour corriger"], ["Quel mot peut introduire une conséquence ?", "donc"]]),
    ],
    Anglais: [
      chapter("Prétérit", "Parler d’actions passées avec verbes réguliers et irréguliers.", ["Past simple", "-ed", "Irréguliers", "Questions"], [["Mets au passé : I play football", "i played football"], ["Quel est le passé de go ?", "went"], ["Que signifie yesterday ?", "hier"], ["Quel est le passé de eat ?", "ate"]]),
      chapter("Compréhension écrite", "Lire un texte anglais, repérer les mots-clés et répondre.", ["Who", "Where", "When", "Why"], [["Que signifie who ?", "qui"], ["Que signifie where ?", "où"], ["Que signifie when ?", "quand"], ["Que signifie why ?", "pourquoi"]]),
    ],
    Sciences: [
      chapter("Cellule et vivant", "Comprendre la cellule, la membrane, le noyau et l’organisation du vivant.", ["Cellule", "Membrane", "Noyau", "Organe"], [["Quel élément délimite la cellule ?", "la membrane"], ["La cellule est-elle l’unité du vivant ?", "oui"], ["Où se trouve l’information génétique ?", "dans le noyau"], ["Un organe est-il composé de cellules ?", "oui"]]),
      chapter("Démarche scientifique", "Observer, formuler une hypothèse, expérimenter et conclure.", ["Observation", "Hypothèse", "Expérience", "Conclusion"], [["Que formule-t-on avant une expérience ?", "une hypothèse"], ["À quoi sert une conclusion ?", "à répondre au problème"], ["Une expérience sert-elle à tester une idée ?", "oui"], ["Quelle étape vient après l’observation ?", "l’hypothèse"]]),
    ],
    "Histoire-Géo": [
      chapter("Révolution française", "Causes, événements et conséquences de la Révolution française.", ["1789", "Monarchie", "Droits", "République"], [["En quelle année commence la Révolution française ?", "1789"], ["Quel régime est remis en cause ?", "la monarchie"], ["La Déclaration affirme-t-elle des droits ?", "oui"], ["Quel événement symbolique a lieu le 14 juillet 1789 ?", "la prise de la bastille"]]),
      chapter("Document géographique", "Analyser une carte, un graphique ou un paysage.", ["Carte", "Graphique", "Légende", "Analyse"], [["À quoi sert une légende ?", "à expliquer les symboles"], ["Un graphique représente-t-il des données ?", "oui"], ["Que faut-il lire en premier sur une carte ?", "le titre"], ["Une carte peut-elle montrer un territoire ?", "oui"]]),
    ],
    "Culture générale": [
      chapter("Médias et esprit critique", "Vérifier une information, comparer les sources et repérer les doutes.", ["Source", "Date", "Auteur", "Fiabilité"], [["Pourquoi vérifier une source ?", "pour savoir si elle est fiable"], ["Faut-il comparer plusieurs sources ?", "oui"], ["Une date aide-t-elle à vérifier une information ?", "oui"], ["Une information sans source est-elle toujours fiable ?", "non"]]),
      chapter("Monde actuel", "Institutions, innovation, écologie et société contemporaine.", ["Institutions", "Innovation", "Écologie", "Société"], [["Le recyclage aide-t-il l’environnement ?", "oui"], ["Une innovation est-elle une nouveauté utile ?", "oui"], ["Pourquoi apprendre l’actualité ?", "pour comprendre le monde"], ["L’écologie concerne-t-elle l’environnement ?", "oui"]]),
    ],
  },
};
...
function getLessonDetails(title) {
  const common = {
    definition: `Ce chapitre permet de comprendre la notion “${title}” avec une méthode claire, des exemples guidés et des exercices progressifs.`,
    example: "Exemple guidé : lis la consigne, repère les mots importants, applique la méthode, puis vérifie ta réponse étape par étape.",
  ...
  const lessons = {
    "Nombres et calculs": { definition: "Les nombres servent à compter, mesurer et résoudre des situations. Les opérations transforment ces nombres : additionner pour regrouper, soustraire pour enlever, multiplier pour répéter, diviser pour partager.", example: "Pour calculer 245 + 138 : unités 5 + 8 = 13, on écrit 3 et on retient 1. Dizaines 4 + 3 + 1 = 8. Centaines 2 + 1 = 3. Résultat : 383.", mistakes: ["Oublier une retenue", "Confondre addition et multiplication", "Ne pas lire toute la question", "Répondre sans phrase finale"], summary: "Lire l’énoncé, choisir la bonne opération, poser le calcul et vérifier." },
    "Fractions et décimaux": { definition: "Une fraction représente une partie d’un tout partagé en parts égales. Le haut indique les parts prises, le bas indique le nombre total de parts.", example: "Dans 3/4, le 4 indique 4 parts égales et le 3 indique que l’on prend 3 parts. On lit : trois quarts.", mistakes: ["Oublier que les parts doivent être égales", "Comparer sans regarder le dénominateur", "Confondre 1/2 et 2/1"], summary: "Une fraction se comprend mieux avec un dessin ou un partage." },
    "Équations": { definition: "Une équation est une égalité avec une inconnue. Résoudre, c’est trouver la valeur de cette inconnue.", example: "x + 8 = 15. On enlève 8 des deux côtés : x = 15 - 8 = 7.", mistakes: ["Faire une opération d’un seul côté", "Oublier de vérifier", "Confondre x + 8 et 8x"], summary: "On garde l’égalité équilibrée en faisant la même opération des deux côtés." },
    "Calcul numérique": { definition: "Le calcul numérique utilise entiers, décimaux, relatifs, fractions et puissances. Il faut respecter les priorités opératoires.", example: "Dans 3 + 2 × 5, on calcule d’abord 2 × 5 = 10, puis 3 + 10 = 13.", mistakes: ["Calculer de gauche à droite sans priorité", "Oublier les parenthèses", "Mal gérer les nombres négatifs"], summary: "Parenthèses, puis multiplications/divisions, puis additions/soustractions." },
    "Grammaire": { definition: "La grammaire explique la construction des phrases : sujet, verbe, nom, adjectif et accords.", example: "Dans ‘Le petit chat dort’, le sujet est ‘Le petit chat’, le verbe est ‘dort’, le nom est ‘chat’ et l’adjectif est ‘petit’.", mistakes: ["Confondre sujet et verbe", "Oublier les accords", "Ne pas relire"], summary: "Cherche le verbe, puis demande-toi qui fait l’action." },
    "Les états de l’eau": { definition: "L’eau peut être solide, liquide ou gazeuse. Le changement d’état dépend de la température.", example: "Un glaçon est solide. Quand il chauffe, il fond et devient liquide. Quand l’eau chauffe beaucoup, elle devient vapeur.", mistakes: ["Dire que la glace n’est pas de l’eau", "Confondre vapeur et fumée", "Oublier la température"], summary: "Solide, liquide et gaz sont trois états possibles de l’eau." },
    "Révolution française": { definition: "La Révolution française commence en 1789. Elle remet en cause la monarchie absolue et affirme de nouveaux droits.", example: "La prise de la Bastille du 14 juillet 1789 devient un symbole de la contestation du pouvoir royal.", mistakes: ["Oublier 1789", "Confondre monarchie et république", "Ne pas expliquer les causes"], summary: "La Révolution transforme profondément la société française." },
  };

  return lessons[title] || common;
}
...
function feedback(score, level) {
  ...
  if (score >= 40) return `${level} : quelques difficultés. Revois les méthodes et les exemples.`;
  return `${level} : il faut reprendre les bases du chapitre avant de continuer.`;
}
    ...
    <main>
      <section className="max-w-7xl mx-auto px-6 pt-16 pb-20 grid lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm text-white/80 mb-6">✨ Cours personnalisés après connexion</div>
        ...
        <div className="rounded-[2rem] border border-white/10 bg-white/10 shadow-2xl text-white overflow-hidden p-6">
          <div className="rounded-[1.5rem] bg-slate-950/80 border border-white/10 p-5">
            <div className="flex items-center justify-between mb-5"><div><p className="text-sm text-white/50">Tableau de bord élève</p><h2 className="text-2xl font-bold">{isLoggedIn ? "Espace connecté" : "Connexion requise"}</h2></div><div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-pink-500 flex items-center justify-center">🧠</div></div>
            <div className="grid grid-cols-2 gap-3"><div className="rounded-2xl bg-white/10 p-4"><p className="text-white/50 text-sm">Progression</p><p className="text-3xl font-black mt-2">{score}%</p></div><div className="rounded-2xl bg-white/10 p-4"><p className="text-white/50 text-sm">Chapitres terminés</p><p className="text-3xl font-black mt-2">{completed.length}</p></div></div>
            <div className="mt-4 rounded-2xl bg-white p-5 text-slate-950"><p className="font-bold flex items-center gap-3">⭐ Assistant IA</p><p className="text-sm text-slate-600 mt-3">{aiMessage}</p></div>
          </div>
        </div>
      </section>
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="rounded-[2rem] bg-white text-slate-950 p-8 md:p-12 shadow-2xl">
        ...
        <div className="mt-8 rounded-3xl bg-indigo-50 border border-indigo-100 p-6"><h2 className="text-2xl font-black mb-3">Leçon détaillée</h2><p className="text-slate-700 leading-relaxed text-lg">{chapter.details.definition}</p></div>
        <div className="mt-6 rounded-3xl bg-emerald-50 border border-emerald-100 p-6"><h2 className="text-2xl font-black mb-3">Exemple guidé</h2><p className="text-slate-700 leading-relaxed text-lg">{chapter.details.example}</p></div>
        <div className="mt-6 grid md:grid-cols-2 gap-6"><div className="rounded-3xl bg-rose-50 border border-rose-100 p-6"><h2 className="text-2xl font-black mb-4">Erreurs fréquentes</h2><ul className="space-y-2 text-slate-700">{chapter.details.mistakes.map((m) => <li key={m}>⚠️ {m}</li>)}</ul></div><div className="rounded-3xl bg-slate-100 p-6"><h2 className="text-2xl font-black mb-4">Résumé à retenir</h2><p className="text-slate-700 leading-relaxed">{chapter.details.summary}</p><p className="mt-4 text-indigo-700 font-bold">Conseil IA : commence par 2 exercices simples, puis passe au niveau supérieur.</p></div></div>
